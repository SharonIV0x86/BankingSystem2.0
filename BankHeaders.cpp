...
void Account ::savingLogs(int logAction)
{
    ...
    {
    case 1:
        log << "\n\n\t[++] User Named " << File->permanentAccountName << " CREATED an account! On " << timeString << std::endl;
        break;
    case 2:
        log << "\n\n\t[+] User Named " << File->permanentAccountName << " LOGGED into account on " << timeString << std::endl;
        break;
    case 3:
        moneyLogs << "\n\n\t[+] User Named " << File->permanentAccountName << " DEPOSITED " << File->depositAmount << " on " << timeString << " remaining remainingBalance " << File->remainingBalance << std::endl;
        break;
    case 4:
        moneyLogs << "\n\n\t[-] User Named " << File->permanentAccountName << " WITHDRAWN " << File->withdrawAmount << " on " << timeString << " remaining remainingBalance " << File->remainingBalance << std::endl;
        break;
    case 5:
        log << "\n\n\t[+ -]User Named " << File->permanentAccountName << " TRIED LOGGING INTO THE ACCOUNT WITH WRONG CREDENTIALS!! " << timeString << std::endl;
        break;
    case 6:
        moneyLogs << "\n\n\t[--]User Named " << File->permanentAccountName << " DELETED their account on " << timeString << std::endl;
        break;
